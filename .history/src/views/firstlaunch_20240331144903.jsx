    ...
    render: function () {
      return (
        <ModalView
          ...
          type="first-launch-modal"
          title={this.props.title}
        >
          <p>
            <strong>Bookmark-Manager</strong> is a simple bookmarks app which
            you can simply keep your bookmarks, categorized. <br />
            If you want to see how this shit works, i can load some example
            bookmarks for you. <br />
            Don't worry that example data will not be persistent. At any time,
            you can refresh and they're gone... <br />
          </p>
          ...
          <a href="#" onClick={this.cancel} className="cancel">
            No, give me a blank canvas!
          </a>
        </ModalView>
      );
    },
